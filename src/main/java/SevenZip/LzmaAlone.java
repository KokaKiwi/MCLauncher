...
public class LzmaAlone
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        if (params.Command == CommandLine.kBenchmak)
        {
            ...
            SevenZip.LzmaBench.LzmaBenchmark(params.NumBenchmarkPasses,
                    dictionary);
        }
                ...
                || params.Command == CommandLine.kDecode)
        {
            ...
            final java.io.BufferedInputStream inStream = new java.io.BufferedInputStream(
                    new java.io.FileInputStream(inFile));
            final java.io.BufferedOutputStream outStream = new java.io.BufferedOutputStream(
