...
public class BinTree extends InWindow
{
    ...
    public int GetMatches(int[] distances) throws IOException
    {
        ...
        int offset = 0;
        final int matchMinPos = _pos > _cyclicBufferSize ? _pos
                - _cyclicBufferSize : 0;
        ...
        if (HASH_ARRAY)
        {
            int temp = CrcTable[_bufferBase[cur] & 0xFF] ^ _bufferBase[cur + 1]
                    & 0xFF;
        ...
        {
            hashValue = _bufferBase[cur] & 0xFF
        ...
        while (true)
        {
            ...
            final int cyclicPos = (delta <= _cyclicBufferPos ? _cyclicBufferPos
                    - delta : _cyclicBufferPos - delta + _cyclicBufferSize) << 1;
